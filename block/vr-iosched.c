...
static struct request *vr_expired_request(struct vr_data *vd, int ddir)
{
	struct request *rq;
...
static struct request *vr_check_fifo(struct vr_data *vd)
{
...
static struct request *vr_choose_request(struct vr_data *vd)
{
