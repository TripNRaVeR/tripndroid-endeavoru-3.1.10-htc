...
static struct dvfs core_dvfs_table[] = {
	...
	CORE_DVFS("cpu_lp", 0, 1, KHZ,        1, 294000, 342000, 427000, 475000,  513000,  620000,  620000,  620000),
	CORE_DVFS("cpu_lp", 1, 1, KHZ,   204000, 294000, 342000, 427000, 475000,  513000,  620000,  620000,  620000),
	CORE_DVFS("cpu_lp", 2, 1, KHZ,   204000, 295000, 370000, 428000, 475000,  513000,  620000,  620000,  620000),
	CORE_DVFS("cpu_lp", 3, 1, KHZ,        1,      1,      1,      1,      1,       1,  450000,  450000,  579000),

	CORE_DVFS("emc",    0, 1, KHZ,        1, 266500, 266500, 266500, 266500,  533000,  625000,  667000,  667000),
	...
	CORE_DVFS("vde",    0, 1, KHZ,   192000, 288000, 360000, 408000, 492000,  533000,  564000,  600000,  625000),
	CORE_DVFS("mpe",    0, 1, KHZ,   192000, 228000, 300000, 396000, 492000,  533000,  564000,  600000,  625000),
	CORE_DVFS("2d",     0, 1, KHZ,   192000, 228000, 300000, 396000, 492000,  533000,  564000,  600000,  625000),
	CORE_DVFS("epp",    0, 1, KHZ,   192000, 228000, 300000, 396000, 492000,  533000,  564000,  600000,  625000),
	CORE_DVFS("3d",     0, 1, KHZ,   192000, 228000, 300000, 396000, 492000,  533000,  564000,  600000,  625000),
	CORE_DVFS("3d2",    0, 1, KHZ,   192000, 228000, 300000, 396000, 492000,  533000,  564000,  600000,  625000),
	CORE_DVFS("se",     0, 1, KHZ,   144000, 182000, 240000, 312000, 492000,  533000,  564000,  600000,  625000),
	CORE_DVFS("msenc",  0, 1, KHZ,   144000, 182000, 240000, 312000, 492000,  533000,  564000,  600000,  625000),

	CORE_DVFS("vde",    1, 1, KHZ,   192000, 288000, 360000, 408000, 492000,  533000,  564000,  600000,  625000),
	CORE_DVFS("mpe",    1, 1, KHZ,   192000, 228000, 300000, 396000, 492000,  533000,  564000,  600000,  625000),
	CORE_DVFS("2d",     1, 1, KHZ,   192000, 228000, 300000, 396000, 492000,  533000,  564000,  600000,  625000),
	CORE_DVFS("epp",    1, 1, KHZ,   192000, 228000, 300000, 396000, 492000,  533000,  564000,  600000,  625000),
	CORE_DVFS("3d",     1, 1, KHZ,   192000, 228000, 300000, 396000, 492000,  533000,  564000,  600000,  625000),
	CORE_DVFS("3d2",    1, 1, KHZ,   192000, 228000, 300000, 396000, 492000,  533000,  564000,  600000,  625000),
	CORE_DVFS("se",     1, 1, KHZ,   144000, 182000, 240000, 312000, 492000,  533000,  564000,  600000,  625000),
	CORE_DVFS("msenc",  1, 1, KHZ,   144000, 182000, 240000, 312000, 492000,  533000,  564000,  600000,  625000),

	CORE_DVFS("vde",    2, 1, KHZ,   192000, 288000, 360000, 408000, 492000,  533000,  564000,  600000,  625000),
	CORE_DVFS("mpe",    2, 1, KHZ,   192000, 228000, 300000, 396000, 492000,  533000,  564000,  600000,  625000),
	CORE_DVFS("2d",     2, 1, KHZ,   192000, 228000, 300000, 396000, 492000,  533000,  564000,  600000,  625000),
	CORE_DVFS("epp",    2, 1, KHZ,   192000, 228000, 300000, 396000, 492000,  533000,  564000,  600000,  625000),
	CORE_DVFS("3d",     2, 1, KHZ,   192000, 228000, 300000, 396000, 492000,  533000,  564000,  600000,  625000),
	CORE_DVFS("3d2",    2, 1, KHZ,   192000, 228000, 300000, 396000, 492000,  533000,  564000,  600000,  625000),
	CORE_DVFS("se",     2, 1, KHZ,   144000, 182000, 240000, 312000, 492000,  533000,  564000,  600000,  625000),
	CORE_DVFS("msenc",  2, 1, KHZ,   144000, 182000, 240000, 312000, 492000,  533000,  564000,  600000,  625000),

	CORE_DVFS("vde",    3, 1, KHZ,        1,      1,      1,      1,      1,       1,  564000,  600000,  625000),
	CORE_DVFS("mpe",    3, 1, KHZ,        1,      1,      1,      1,      1,       1,  564000,  600000,  625000),
	CORE_DVFS("2d",     3, 1, KHZ,        1,      1,      1,      1,      1,       1,  564000,  600000,  625000),
	CORE_DVFS("epp",    3, 1, KHZ,        1,      1,      1,      1,      1,       1,  564000,  600000,  625000),
	CORE_DVFS("3d",     3, 1, KHZ,        1,      1,      1,      1,      1,       1,  564000,  600000,  625000),
	CORE_DVFS("3d2",    3, 1, KHZ,        1,      1,      1,      1,      1,       1,  564000,  600000,  625000),
	CORE_DVFS("se",     3, 1, KHZ,        1,      1,      1,      1,      1,       1,  564000,  600000,  625000),
	CORE_DVFS("msenc",  3, 1, KHZ,        1,      1,      1,      1,      1,       1,  564000,  600000,  625000),
	...
	CORE_DVFS("host1x", 3, 1, KHZ,        1,      1,      1,      1,      1,       1,  300000,  324000,  324000),

	CORE_DVFS("cbus",   0, 1, KHZ,        1, 228000, 275000, 332000, 380000,  416000,  416000,  416000,  416000),
	CORE_DVFS("cbus",   1, 1, KHZ,   192000, 228000, 275000, 332000, 380000,  408000,  564000,  600000,  625000),
	CORE_DVFS("cbus",   2, 1, KHZ,   192000, 228000, 332000, 380000, 408000,  408000,  564000,  600000,  625000),
	CORE_DVFS("cbus",   3, 1, KHZ,        1,      1,      1,      1,      1,       1,  533000,  625000,  625000),

	CORE_DVFS("pll_c",  -1, 1, KHZ,  533000, 667000, 667000, 800000, 800000, 1066000, 1400000, 1400000, 1400000),
