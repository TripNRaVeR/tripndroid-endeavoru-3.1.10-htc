...
static struct dvfs core_dvfs_table[] = {
	...
	CORE_DVFS("vde",    0, 1, KHZ,   200000, 288000, 360000, 408000, 446000,  492000,  512000,  564000,  600000),
	CORE_DVFS("mpe",    0, 1, KHZ,   200000, 228000, 300000, 396000, 446000,  492000,  512000,  564000,  600000),
	CORE_DVFS("2d",     0, 1, KHZ,   200000, 228000, 300000, 396000, 446000,  492000,  512000,  564000,  600000),
	CORE_DVFS("epp",    0, 1, KHZ,   200000, 228000, 300000, 396000, 446000,  492000,  512000,  564000,  600000),
	CORE_DVFS("3d",     0, 1, KHZ,   200000, 228000, 300000, 396000, 446000,  492000,  512000,  564000,  600000),
	CORE_DVFS("3d2",    0, 1, KHZ,   200000, 228000, 300000, 396000, 446000,  492000,  512000,  564000,  600000),
	CORE_DVFS("se",     0, 1, KHZ,   144000, 182000, 240000, 312000, 446000,  492000,  512000,  564000,  600000),

	CORE_DVFS("vde",    1, 1, KHZ,   200000, 288000, 360000, 408000, 446000,  492000,  512000,  564000,  600000),
	CORE_DVFS("mpe",    1, 1, KHZ,   200000, 228000, 300000, 396000, 446000,  492000,  512000,  564000,  600000),
	CORE_DVFS("2d",     1, 1, KHZ,   200000, 228000, 300000, 396000, 446000,  492000,  512000,  564000,  600000),
	CORE_DVFS("epp",    1, 1, KHZ,   200000, 228000, 300000, 396000, 446000,  492000,  512000,  564000,  600000),
	CORE_DVFS("3d",     1, 1, KHZ,   200000, 228000, 300000, 396000, 446000,  492000,  512000,  564000,  600000),
	CORE_DVFS("3d2",    1, 1, KHZ,   200000, 228000, 300000, 396000, 446000,  492000,  512000,  564000,  600000),
	CORE_DVFS("se",     1, 1, KHZ,   144000, 182000, 240000, 312000, 446000,  492000,  512000,  564000,  600000),

	CORE_DVFS("vde",    2, 1, KHZ,   200000, 288000, 360000, 408000, 446000,  492000,  512000,  564000,  600000),
	CORE_DVFS("mpe",    2, 1, KHZ,   200000, 228000, 300000, 396000, 446000,  492000,  512000,  564000,  600000),
	CORE_DVFS("2d",     2, 1, KHZ,   200000, 228000, 300000, 396000, 446000,  492000,  512000,  564000,  600000),
	CORE_DVFS("epp",    2, 1, KHZ,   200000, 228000, 300000, 396000, 446000,  492000,  512000,  564000,  600000),
	CORE_DVFS("3d",     2, 1, KHZ,   200000, 228000, 300000, 396000, 446000,  492000,  512000,  564000,  600000),
	CORE_DVFS("3d2",    2, 1, KHZ,   200000, 228000, 300000, 396000, 446000,  492000,  512000,  564000,  600000),
	CORE_DVFS("se",     2, 1, KHZ,   144000, 182000, 240000, 312000, 446000,  492000,  512000,  564000,  600000),

	CORE_DVFS("vde",    3, 1, KHZ,        1,      1,      1,      1,      1,       1,  512000,  564000,  600000),
	CORE_DVFS("mpe",    3, 1, KHZ,        1,      1,      1,      1,      1,       1,  512000,  564000,  600000),
	CORE_DVFS("2d",     3, 1, KHZ,        1,      1,      1,      1,      1,       1,  512000,  564000,  600000),
	CORE_DVFS("epp",    3, 1, KHZ,        1,      1,      1,      1,      1,       1,  512000,  564000,  600000),
	CORE_DVFS("3d",     3, 1, KHZ,        1,      1,      1,      1,      1,       1,  512000,  564000,  600000),
	CORE_DVFS("3d2",    3, 1, KHZ,        1,      1,      1,      1,      1,       1,  512000,  564000,  600000),
	CORE_DVFS("se",     3, 1, KHZ,        1,      1,      1,      1,      1,       1,  512000,  564000,  600000),
	...
	CORE_DVFS("cbus",   0, 1, KHZ,        1, 240000, 267000, 312000, 446000,  492000,  512000,  564000,  600000),
	CORE_DVFS("cbus",   1, 1, KHZ,   200000, 240000, 267000, 312000, 446000,  492000,  512000,  564000,  600000),
	CORE_DVFS("cbus",   2, 1, KHZ,   200000, 240000, 267000, 312000, 446000,  492000,  512000,  564000,  600000),
	CORE_DVFS("cbus",   3, 1, KHZ,        1,      1,      1,      1,      1,       1,  512000,  564000,  600000),
